...
export default function ConversationScreen(props) {
  ...
  return (
    <View style={{flex:1, backgroundColor:'#fff'}}>
      ...
      <TouchableOpacity
    style={{backgroundColor: "#4D5EBB",height:35,alignItems:"center",alignContent:'center'}}
    appearance='ghost' status='primary'
    textStyle={{color:"#fff"}}
    onPress={() => props.navigation.goBack()}>
      <Image
    style={{ width: 40, height: 30, tintColor: "rgba(255,255,255,0.5)" }}
    source={{ uri: 'https://akveo.github.io/eva-icons/outline/png/128/arrow-ios-downward-outline.png' }}
